...
<head>
    ...
    <link rel=stylesheet href="../../control/gantt/platform.css" type="text/css">
    <link rel=stylesheet href="../../control/gantt/libs/jquery/dateField/jquery.dateField.css" type="text/css">

    <link rel=stylesheet href="../../control/gantt/gantt.css" type="text/css">
    <link rel=stylesheet href="../../control/gantt/ganttPrint.css" type="text/css" media="print">

    <script src="http://apps.bdimg.com/libs/jquery/2.1.4/jquery.min.js"></script>
    <script src="http://apps.bdimg.com/libs/jqueryui/1.10.4/jquery-ui.min.js"></script>

    <script src="../../control/gantt/libs/jquery/jquery.livequery.1.1.1.min.js"></script>
    <script src="../../control/gantt/libs/jquery/jquery.timers.js"></script>

    <script src="../../control/gantt/libs/utilities.js"></script>
    <script src="../../control/gantt/libs/forms.js"></script>
    <script src="../../control/gantt/libs/date.js"></script>
    <script src="../../control/gantt/libs/dialogs.js"></script>
    <script src="../../control/gantt/libs/layout.js"></script>
    <script src="../../control/gantt/libs/i18nJs.js"></script>
    <script src="../../control/gantt/libs/jquery/dateField/jquery.dateField.js"></script>
    <script src="../../control/gantt/libs/jquery/JST/jquery.JST.js"></script>

    <script type="text/javascript" src="../../control/gantt/libs/jquery/svg/jquery.svg.min.js"></script>
    <script type="text/javascript" src="../../control/gantt/libs/jquery/svg/jquery.svgdom.1.8.js"></script>


    <script src="../../control/gantt/ganttUtilities.js"></script>
    <script src="../../control/gantt/ganttTask.js"></script>
    <script src="../../control/gantt/ganttDrawerSVG.js"></script>
    <script src="../../control/gantt/ganttZoom.js"></script>
    <script src="../../control/gantt/ganttGridEditor.js"></script>
    <script src="../../control/gantt/ganttMaster.js"></script>
...
<form id="gimmeBack" style="display:none;" action="" method="post" target="_blank"><input type="hidden" name="prj"
                                                                                          id="gimBaPrj"></form>
...
<div id="gantEditorTemplates" style="display:none;">
  ...
  <div class="ganttButtonBar noprint">
    <div class="buttons">
      <a href="/"><img src="res/twGanttLogo.png" alt="资源甘特图" align="absmiddle" style="max-width: 136px; padding-right: 15px"></a>
    ...
    <button onclick='newProject();' class='button requireWrite newproject'><em>清除项目</em></button>
  ...
  <table class="gdfTable" cellspacing="0" cellpadding="0">
    ...
    <tr style="height:40px">
      ...
      <th class="gdfColHeader gdfResizable" style="width:100px;">资源代码</th>
      <th class="gdfColHeader gdfResizable" style="width:300px;">产品</th>
      ...
      <th class="gdfColHeader gdfResizable" style="width:50px;">持续时间</th>
  ...
  <tr id="tid_(#=obj.id#)" taskId="(#=obj.id#)" class="taskEditRow (#=obj.isParent()?'isParent':''#) (#=obj.collapsed?'collapsed':''#)" level="(#=level#)">
    ...
    <td class="gdfCell"><input type="text" name="code" value="(#=obj.code?obj.code:''#)" placeholder="订单名称1"></td>
  ...
  <div class="ganttTaskEditor">
    <h2 class="taskData">订单编辑</h2>
    <table  cellspacing="1" cellpadding="5" width="100%" class="taskData table" border="0">
          <tr>
        <td width="200" style="height: 80px"  valign="top">
          <label for="code">资源代码</label><br>
          <input type="text" name="code" id="code" value="" size=15 class="formElements" autocomplete='off' maxlength=255 style='width:100%' oldvalue="1">
        </td>
        <td colspan="3" valign="top"><label for="name" class="required">产品</label><br><input type="text" name="name" id="name"class="formElements" autocomplete='off' maxlength=255 style='width:100%' value="" required="true" oldvalue="1"></td>
          </tr>
      ...
      <tr>
        ...
        <td valign="top" nowrap>
          ...
          <tr>
            <td colspan="4">
              <label for="description">备注</label><br>
