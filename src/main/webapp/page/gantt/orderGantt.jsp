...
<script type="text/javascript">
    ...
    function getDemoProject() {
        var orderData = [];
        $.ajax({
            url: "<%=basePath%>json/basedate/order.json",
            type: "get",
            async: false,
...
<div id="gantEditorTemplates" style="display:none;">
  ...
  <table class="gdfTable" cellspacing="0" cellpadding="0">
    ...
    <tr style="height:40px">
      ...
      <th class="gdfColHeader gdfResizable" style="width:100px;">订单名称</th>
      <th class="gdfColHeader gdfResizable" style="width:300px;">订单代码</th>
  ...
  <div class="ganttTaskEditor">
    ...
    <table  cellspacing="1" cellpadding="5" width="100%" class="taskData table" border="0">
        ...
        <td width="200" style="height: 80px"  valign="top">
          <label for="code">订单名称</label><br>
          <input type="text" name="code" id="code" value="" size=15 class="formElements" autocomplete='off' maxlength=255 style='width:100%' oldvalue="1">
        </td>
        <td colspan="3" valign="top"><label for="name" class="required">订单代码</label><br><input type="text" name="name" id="name"class="formElements" autocomplete='off' maxlength=255 style='width:100%' value="" required="true" oldvalue="1"></td>
          </tr>
